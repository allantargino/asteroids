...
Ship::Ship(QOpenGLWidget* _glWidget)
{
    glWidget = _glWidget;
...
void Ship::destroyShaders()
{
    glDeleteProgram(shaderProgram);
}

void Ship::createVBOs()
{
    glWidget->makeCurrent();
    destroyVBOs();
...
void Ship::readOFFFile(QString const& fileName)
{
    std::ifstream stream;
